...
# The `Radar` class is a subclass of `Dashboard.Item` that represents a radar chart and can be customized with different
# themes and data.
class Radar(Dashboard.Item):
    ...
    def __call__(self, json_data,title='Radar chart'):
        """
